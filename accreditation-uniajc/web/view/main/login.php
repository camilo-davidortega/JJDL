...
<head>
    ...
    <title>Iniciar Sesión | UNIAJC</title>
...
<div class="footer-top clearfix">
    ...
    <div style="background: linear-gradient(#0054c1, #001a36);" class="logo">
        <a href="index.php"><img style="width: 22%;" src="../../assets/img/main/logo-white.png" alt=""
                                 class="img-fluid"></a>
    </div>
        ...
        <nav class="nav-menu float-right d-none d-lg-block">
            ...
            <ul>
                <li class="active"><a href="#topbar"><img class="icon-nav"
                                                          src="../../assets/img/icons/navbar/user.svg"/>Iniciar
                        Sesión</a>
                </li>
                <li><a href="index.php"><img class="icon-nav"
            ...
            <div class="col-lg-12 d-flex justify-content-center about-content">
                <div class="row">
                    ...
                    <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <form action="../login/login-back.php" method="POST" role="form" class="php-email-form"
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <button type="submit" value="Conectarse"
                                            name="conectarse">Ingresar
                                    </button>
                                </div>

                                <br>
                                <div class="text-center">
                                    <p style="text-align: center">¿Olvidaste tu contraseña?</p>
                                    <img
                                            class="icon-nav"
                                            src="../../assets/img/icons/form/password-recover.svg"/><a
                                            href="../restore/restore-main.php">Restablecer</a>
                                </div>
