...
<head>
    ...
    <title>Examinar - Estudiante | UNIAJC</title>
...
<header id="header">
    ...
    <div class="container">
        ...
        <nav class="nav-menu float-right d-none d-lg-block">
            ...
            <ul>
                <li><a href="student.php"><img class="icon-nav"
                    ...
                    <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div id="survey" class="section-title">
                            <h2><img class="icon-content hover-scale"
                                     src="../../assets/img/icons/navbar-admin/student.svg"/>Estudiante</h2>
                        ...
                        <div class="scroll-table">
                            ...
                            <td><input class='results' type='submit' onclick=\"this.form.action='student-results.php?name=" . $name . "&email=" . $email . "&id_survey=" . $fila["id_survey"] . "'\" value='Examinar' /></td>
                            </form></div>";
                                }
