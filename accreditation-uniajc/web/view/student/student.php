...
<head>
    ...
    <title>Estudiantes - Administrador | UNIAJC</title>
...
<main id="main">
    ...
    <section id="contact" class="contact about">
        <div class="container-main">
                    ...
                    <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div id="survey" class="section-title">
                            <h2><img class="icon-content hover-scale"
                                     src="../../assets/img/icons/navbar-admin/student.svg"/>Crear un Estudiante</h2>
                        </div>

                        <form action="student-back-insert.php" method="POST" role="form" class="php-email-form"
            ...
            <?php
            $declaracionSQL2 = "SELECT COUNT(id_user) AS students_created FROM user WHERE type_user='Estudiante'";
            ...
            <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                <div class="section-title">
                    <h2><img class="icon-content hover-scale"
                             src="../../assets/img/icons/form/history.svg"/>Historial de Estudiantes -
                        Registros: <?php echo $fila2['students_created'] ?></h2>
                        ...
                        <table id="encuesta" class="table-list">
                            ...
                            <tr>
                                <th><img class="icon-nav"
                                         src="../../assets/img/icons/table/id.svg"/>ID de Estudiante
                                </th>
                                <th><img class="icon-nav"
                            ...
                            <?php
                            $statementSQL = "SELECT * FROM user WHERE type_user='Estudiante' ORDER BY created_date_user DESC";
                           ...
                           <td><textarea name='created_date' readonly='readonly'>" . iconv('ISO-8859-2', 'UTF-8', strftime("%A, %d de %B, %Y - ", strtotime($row["created_date_user"]))) . date_format($date, 'h:i A') . "</textarea></td>
                            ...
                            <td><input class='results' type='submit' onclick=\"this.form.action='student-examine.php'\" value='Examinar' /></td>
                            <td><input class='update' type='submit' onclick=\"this.form.action='student-back-update.php'\" value='Modificar' /></td>
                            <td><input class='delete' type='submit' onclick=\"this.form.action='student-back-delete.php'\" value='Eliminar' /></td>
                            </form></div>";
                            }
                            ?>
                        </table>
