...
<head>
    ...
    <title>Examinar - Encuesta | UNIAJC</title>
...
<header id="header">
    ...
    <div class="container">
        ...
        <nav class="nav-menu float-right d-none d-lg-block">
            ...
            <ul>
                <li><a href="../main/admin-main.php"><img class="icon-nav"
        ...
        <div class="container-main">
            ...
            <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                ...
                <div id="survey" class="section-title">
                    ...
                    <h2><img class="icon-content hover-scale"
                             src="../../assets/img/icons/navbar-admin/summary.svg"/>Resultados de la Encuesta<br>
                    </h2>
...
WHERE relation_survey='" . $_POST["id"] . "'";
                        $query = mysqli_query($connection, $statementSQL);

                        $declaracionSQL2 = "SELECT COUNT(id_question) AS question_total 
FROM question
WHERE relation_survey='" . $_POST["id"] . "' AND status_question='on'";

                        $consulta2 = mysqli_query($connection, $declaracionSQL2);
                        $fila2 = mysqli_fetch_assoc($consulta2);
                        $total = $fila2['question_total'];
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                            ...
                            echo '<h5 style="text-align: center"><img class="icon-form"
                             src="../../assets/img/icons/navbar-admin/question.svg"/>Pregunta: ' . $i . ' de ' . $total . '<br>
                    </h5>
                 <h5 class="title"><a style="cursor: default" href="#question">' . $row["title_question"] . '</a></h5>
                  <p class="description">' . $row["description_question"] . '</p><br>
                        ...
                        echo '<div id="chart_div' . $i . '"></div>';
                            ...
                            while ($row2 = mysqli_fetch_array($query2)) {
                                ...
                                while ($row5 = mysqli_fetch_assoc($query5)) {
                                    echo "
                                            <input readonly type='text' style='width:100%' name='abierta' value=' " . $row5["answer_open"] . "'><br>";
                                }
                            }
                        }
