...
<head>
    ...
    <title>Restablecer contraseña | UNIAJC</title>
...
<header id="header">
    ...
    <div class="container">
        ...
        <nav class="nav-menu float-right d-none d-lg-block">
            ...
            <ul>
                <li><a href="../main/login.php"><img class="icon-nav"
                    ...
                    <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div id="login" class="section-title">
                            <h2><img class="icon-content hover-scale"
                                     src="../../assets/img/icons/form/password-recover.svg"/>Restablecer Contraseña</h2>
                        </div>

                        <form action="restore-back.php" method="POST" role="form" class="php-email-form"
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="sent-message">Se ha enviado el restablecimiento de contraseña al correo
                                        diligenciado.
                                    </div>
                                </div>
