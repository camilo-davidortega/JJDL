...
<head>
    ...
    <title>Confirmar llave | UNIAJC</title>
...
<header id="header">
    ...
    <div class="container">
        ...
        <nav class="nav-menu float-right d-none d-lg-block">
            ...
            <ul>
                <li><a href="../restore/restore-main.php"><img class="icon-nav"
                    ...
                    <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div id="login" class="section-title">
                            <h2><img class="icon-content hover-scale"
                                     src="../../assets/img/icons/form/key.svg"/>Confirmar llave</h2>
                        </div>

                        <form action="confirm-key-back.php" method="POST" role="form" class="php-email-form"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12 form-group">
                                    <div class="col-lg-12 form-group">
                                        <a class="default" href="#email"><img
                                                    class="icon-form"
                                                    src="../../assets/img/icons/form/key.svg"/>LLAVE:</a><input
                                                type="text"
                                                class="form-control text-center"
                                                placeholder="your key"
                                                name="key"
                                                data-rule="minlen:5"
                                                data-msg="Por favor, Ingresa una llave válida"/>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="sent-message">Se ha confirmado correctamente la llave.</div>
                                </div>

                                <div class="text-center">
                                    <button type="submit" value="Confirmar"
                                            name="confirm">Validar
                                    </button>
                                </div>

                                <br>
                                <div class="text-center">
                                    <p style="text-align: center">¿Perdiste la llave?</p>
                                    <img
                                            class="icon-nav"
                                            src="../../assets/img/icons/form/password-recover.svg"/><a
                                            href="../restore/restore-main.php">Solicitar una nueva llave</a>
                                </div>
